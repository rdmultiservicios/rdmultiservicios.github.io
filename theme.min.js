    ...
    initializeHover: function(e, t, i) {
        ...
        o.addEventListener("keydown", (n => {
            if (40 === n.which)
                ...
                s = c,
                i.list.offsetHeight < c.getBoundingClientRect().top && (i.list.scrollTop = c.getBoundingClientRect().top + i.list.scrollTop)) : (s = i.list.firstChild).classList.add("active");
            else if (38 === n.which) {
                var a, c;
                if (n.preventDefault(),
                a = i.list.querySelector(".active")) {
                    ...
                    (s = i.list.firstChild.parentNode).classList.add("active")
